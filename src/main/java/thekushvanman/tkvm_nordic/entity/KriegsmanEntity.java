...
import thekushvanman.tkvm_nordic.entity.ai.PatrolRoadGoal;
...
public class KriegsmanEntity extends Monster {
    ...
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(KriegsmanEntity.class, EntityDataSerializers.INT);
    ...
    public KriegsmanEntity(EntityType<? extends Monster> type, Level level) {
        ...
        if (this.random.nextFloat() < 0.5F) { // 50% chance to carry a shield
            this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(ModItems.ROUNDSHIELD.get()));
        }

        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ModItems.NASAL_HELMET.get()));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new PatrolRoadGoal(this, 0.8D, 100, 200));
